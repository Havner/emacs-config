...
(global-set-key (kbd "<f6>") #'ag)      ; not builtin
(global-set-key (kbd "<f7>") #'find-dired)
(global-set-key (kbd "<C-f7>") #'locate)
...
(with-eval-after-load 'flycheck
  (define-key projectile-mode-map (kbd "<f10>") #'(lambda ()
                                                   (interactive)
                                                   (flycheck-buffer)
...
(cl-case havner/completing
  ('helm
   ...
   (global-set-key (kbd "<f6>") #'helm-ag)
   (global-set-key (kbd "<f7>") #'helm-find)
   (global-set-key (kbd "<C-f7>") #'helm-locate)
...
(with-eval-after-load 'flycheck
  (cl-case havner/completing
    ('helm
     (define-key projectile-mode-map (kbd "<f10>") #'helm-flycheck)
     (define-key flycheck-command-map (kbd "<SPC>") #'helm-flycheck))
    ('ivy
     (define-key projectile-mode-map (kbd "<f10>") #'counsel-flycheck)
