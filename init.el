...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ag anzu avy beginend ccls cmake-mode company company-auctex consult
        ...
        smart-tabs-mode sokoban spacemacs-theme ssh-config-mode swift-mode
        switch-window symbol-overlay unfill vdiff vertico vterm vundo wgrep
        which-key window-jump windresize writeroom-mode yaml-mode yasnippet
        ztree))
