...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ag anzu avy beginend ccls cmake-mode company company-auctex consult
        ...
        flycheck god-mode helpful json-mode json-reformat kotlin-mode leader-key
        lorem-ipsum lsp-ui lua-mode magit marginalia markdown-mode minimap
        multi-vterm mwim neotree ob-rust orderless org-bullets org-tree-slide
        ox-twbs package-lint page-break-lines paradox parinfer-rust-mode
        projectile rainbow-delimiters rg rpm-spec-mode rust-mode shackle
        smart-tabs-mode sokoban soong-mode spacemacs-theme ssh-config-mode
        swift-mode switch-window symbol-overlay unfill vdiff vertico vterm vundo
        wgrep which-key window-jump windresize writeroom-mode yaml-mode
        yasnippet ztree))
