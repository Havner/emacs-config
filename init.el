...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ag anzu avy beginend cmake-mode company company-auctex consult consult-company
        ...
        go-mode god-mode helpful htmlize json-mode json-reformat kkp kotlin-mode
        ...
        parinfer-rust-mode projectile rainbow-delimiters rg rpm-spec-mode
        rust-mode shackle smart-tabs-mode sokoban soong-mode spacemacs-theme
        ssh-config-mode swift-mode switch-window symbol-overlay typescript-mode
        unfill vdiff vertico vterm vundo wgrep which-key window-jump windresize
        writeroom-mode yaml-mode yasnippet ztree))
